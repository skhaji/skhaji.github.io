...
(function( Georgia ) {
  ...
  // Interactive.createLegends = function () {

  //   let legend_colors = Interactive.Gap.MAP_LEGEND_COLORS;

  //   let legend_colors_total = Interactive.Gap.MAP_LEGEND_TOTAL_COLORS;

  //   let legend_data = {
  //     ppgSd: {
  //       'title': 'Funding gap (Per pupil)',
  ...
  //     },
  //     y5ppgSd: {
  //       'title': 'Cost to close gap, phased-in, over 5 years (Per pupil)',
  //       'level': 'school-district',
  //       'timeframe': 'five-year',
  //       'measure': 'per-pupil',
  //       'entries': [
  ...
  //     },
  //     y5tgSd: {
  //       'title': 'Cost to close gap, phased-in, over 5 years (Total)',
  //       'level': 'school-district',
  //       'timeframe': 'five-year',
  //       'measure': 'total',
  //       'entries': [
  ...
  //     },
  //     y5ppgState: {
  //       'title': 'Cost to close gap over 5 years (Per pupil)',
  //       'level': 'state',
  //       'timeframe': 'five-year',
  //       'measure': 'per-pupil',
  //       'entries': [
  ...
  //     },
  //     y5tgState: {
  //       'title': 'Cost to close gap over 5 years (Total)',
  //       'level': 'state',
  //       'timeframe': 'five-year',
  //       'measure': 'total',
  //       'entries': [
  ...
  //   let master_legend = document.getElementById(LEGEND_ID);

  //   // let's create a ul for each legend key
  //   for (const key in legend_data) {

  //     let master_legends_item = document.createElement('li');
  //     let legend = document.createElement('ul');
  //     let legend_title = document.createElement('li');

  //     let classes = [
  //       'legend',
  //       legend_data[key]['level'],
  //       legend_data[key]['timeframe'],
  //       legend_data[key]['measure'],
  //     ];

  //     legend.className = classes.join(' ');

  //     legend_title.className = "dataTitle";
  //     legend_title.innerHTML = legend_data[key].title;

  //     legend.appendChild(legend_title);
      

  //     for (let i = 0; i < legend_data[key].entries.length; i++) {
  //       let item = document.createElement('li');
  //       let color = document.createElement('span');
  //       let text = document.createElement('span');

  //       color.className = 'keycolor';
  //       // color.style.backgroundColor = legend_colors[i];

  //       text.innerHTML = legend_data[key].entries[i];
  ...
  //     master_legends_item.appendChild(legend);
  //     master_legend.appendChild(master_legends_item);
  //   }
  // }
